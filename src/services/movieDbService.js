...
function searchMovies(query) {
    ...
    return fetch('https://api.themoviedb.org/3/search/movie?api_key=68b0765a6d5c51653ecdd4bda511cc24&language=en-US&page=1&query=' + query, requestOptions).then(handleResponse);
}
